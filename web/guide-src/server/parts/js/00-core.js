...
const FIND_CHIPS = ["502 에러가 나요","리버스 프록시 설정","HTTPS 인증서 발급","인증서 갱신",
...
const SEC_KW = {
  ...
  s05:"갱신 자동화 renew cron systemd timer 실패알림 90일",
  s06:"설치 nginx apache tomcat 경로 pem fullchain privkey keystore",
  s07:"체인 중간인증서 누락 오류 모바일 fullchain 순서 진단",
  s08:"tls버전 1.0 1.1 비활성 1.2 1.3 암호스위트 cipher 설정",
  s09:"hsts preload 리다이렉트 혼합콘텐츠 mixed content 업그레이드",
  s10:"mtls 상호인증 클라이언트인증서 ssl_verify_client 내부통신",
  s11:"만료 감시 모니터링 알람 스크립트 대시보드 사고",
  s12:"진단 openssl s_client ssllabs testssl 확인 명령",
