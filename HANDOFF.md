# 핸드오프 — 언어 가이드 확장 (2026-08-31 17차 갱신)
...
### 3. 🟡 기존 그림에 카탈로그 역적용 — 15개 완료, 계속 하면 됩니다

**끝낸 것 (2026-08-31 · 15개)** — 전부 "의도는 이미 그 모델인데 사각형으로 그려져 있던" 것들입니다.
...
```bash
node guide-src/tools/chartcand.mjs            # 전체 (지금 57개)
